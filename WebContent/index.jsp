...
<form action="login">
	<div class="system-title">
		<font face="楷体">在线考试平台</font>
	</div>
	<div class="login-area">
    <div class="title">
        <span></span><font size=6px>登录 </font><span></span><br><br>
        <select>
             <option selected="student" value="0">student</option>
             <option value="1">teacher</option>
             <option value="2">administrator</option>
          </select>
    </div>
    <label for="">
   	 <input id="name" type="text" placeholder="账号" class="common input" name="username" onfocus="xfjianpan(this.id)" value="">
   	 <input id="password" type="password" placeholder="密码" class="common input psw-height" name="userpass" onfocus="xfjianpan(this.id)">
     </label>
    <button class="common login-btn"> 登录</button>
</div>
